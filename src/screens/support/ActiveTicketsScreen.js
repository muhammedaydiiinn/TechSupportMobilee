...
const ActiveTicketsScreen = ({ navigation }) => {
  const { user } = useAuth();
  ...
  const fetchActiveTickets = async () => {
    try {
      ...
      setError('Aktif destek talepleri yüklenirken bir hata oluştu.');
  ...
  if (error) {
    return (
      <View style={styles.centered}>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={fetchActiveTickets}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>Aktif destek talebi bulunamadı.</Text>
          </View>
        }
      />
    </View>
