...
const DepartmentTicketsScreen = () => {
  ...
  const fetchDepartmentTickets = async () => {
    try {
      setLoading(true);
      const response = await ticketService.getDepartmentTickets(user.department_id);
      if (response.success) {
  ...
  if (error) {
    return (
      <View style={styles.centered}>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={fetchDepartmentTickets}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>Departman destek talebi bulunamadı.</Text>
          </View>
        }
      />
    </View>
...
export default DepartmentTicketsScreen; 